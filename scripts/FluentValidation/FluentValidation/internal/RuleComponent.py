...
class RuleComponent[T, TProperty](IRuleComponent):
    ...
    def ErrorCode(self) -> str:
        return (
            self._property_validator.__class__.__name__
        )  # Nombre de la clase del validador
    ...
    def invoke_property_validator(
        self, context: ValidationContext[T], value: TProperty
    ) -> bool:
