class EnglishLanguage:
    ...
    def GetTranslation(key: str) -> str:
        dicc: dict[str, str] = {
            ...
            "LengthValidator": "'{PropertyName}' must be between {min_length} and {max_length} characters. You entered {TotalLength} characters.",
            "MinimumLengthValidator": "The length of '{PropertyName}' must be at least {min_length} characters. You entered {TotalLength} characters.",
            "MaximumLengthValidator": "The length of '{PropertyName}' must be {max_length} characters or fewer. You entered {TotalLength} characters.",
            ...
            "ExactLengthValidator": "'{PropertyName}' must be {max_length} characters in length. You entered {TotalLength} characters.",
