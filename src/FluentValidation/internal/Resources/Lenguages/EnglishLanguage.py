class EnglishLanguage:
    ...
    def GetTranslation(key: str) -> str:
        dicc: dict[str, str] = {
            ...
            "LengthValidator": "'{PropertyName}' must be between {MinLength} and {max_length} characters. You entered {TotalLength} characters.",
            ...
            "Length_Simple": "'{PropertyName}' must be between {MinLength} and {max_length} characters.",
