class SpanishLanguage:
    ...
    def GetTranslation(key: str) -> str:
        dicc: dict[str, str] = {
            ...
            "LengthValidator": "'{PropertyName}' debe tener entre {min_length} y {max_length} caracteres. Actualmente tiene {TotalLength} caracteres.",
            "MinimumLengthValidator": "'{PropertyName}' debe ser mayor o igual que {min_length} caracteres. Ingresó {TotalLength} caracteres.",
            "MaximumLengthValidator": "'{PropertyName}' debe ser menor o igual que {max_length} caracteres. Ingresó {TotalLength} caracteres.",
            ...
            "ExactLengthValidator": "'{PropertyName}' debe tener una longitud de {max_length} caracteres. Actualmente tiene {TotalLength} caracteres.",
