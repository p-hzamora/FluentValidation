class SpanishLanguage:
    ...
    def GetTranslation(key: str) -> str:
        dicc: dict[str, str] = {
            ...
            "LengthValidator": "'{PropertyName}' debe tener entre {MinLength} y {max_length} caracteres. Actualmente tiene {TotalLength} caracteres.",
            ...
            "Length_Simple": "'{PropertyName}' debe tener entre {MinLength} y {max_length} caracteres.",
