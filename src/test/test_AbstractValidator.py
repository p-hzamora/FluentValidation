...
class AbstractValidatorTester(unittest.TestCase):
    ...
    def test_When_the_Validators_pass_then_the_validatorRunner_should_return_true(self):
        self.validator.RuleFor(lambda x: x.Forename).NotNull()
    ...
    def test_Should_validate_public_Field(self):
        self.validator.RuleFor(lambda x: x.NameField).NotNull()
        result = self.validator.validate(Person())
        self.assertEqual(len(result.errors), 1)

    def test_WithMessage_should_override_error_message(self):
        self.validator.RuleFor(lambda x: x.Forename).NotNull().WithMessage("Foo")
        result = self.validator.validate(Person())
    ...
    #     self.validator.RuleFor(lambda x: x.Forename).NotNull().WithErrorCode("ErrCode101")
    #     result = self.validator.validate(Person())
    ...
    #     self.validator.RuleFor(lambda x: x.Forename).NotNull().WithMessage("Foo").WithErrorCode("ErrCode101")
    #     result = self.validator.validate(Person())
    #     self.assertEqual(result.errors[0].ErrorMessage, "Foo")
    #     self.assertEqual(result.errors[0].ErrorCode, "ErrCode101")

    # def WithName_should_override_field_name(self):
    #     self.validator.RuleFor(lambda x: x.Forename).NotNull().WithName("First Name")
    #     result = self.validator.validate(Person())
    ...
    #     self.validator.RuleFor(lambda x: x.Forename).NotNull().WithName(lambda x: x.Surname)
    ...
    #     self.validator.RuleFor(lambda x: x.Surname).NotNull().OverridePropertyName("foo")
    #     result = self.validator.validate(Person())
    #     self.assertEqual(result.errors[0].PropertyName, "foo")

    # def OverridePropertyName_with_lambda_should_override_property_name(self):
    #     self.validator.RuleFor(lambda x: x.Surname).NotNull().OverridePropertyName(lambda x: x.Forename)
    #     result = self.validator.validate(Person())
    ...
    def Should_throw_when_rule_is_null(self):
        with self.assertRaises(AttributeError):  # TODOL: Verify if it's the correct Error
            self.validator.RuleFor(None)

    # def Should_validate_single_property(self):
    #     self.validator.RuleFor(lambda x: x.Forename).NotNull()
    #     self.validator.RuleFor(lambda x: x.Surname).NotNull()
    ...
    #     addressValidator.RuleFor(lambda x: x.Line1).NotNull()
    #     addressValidator.RuleFor(lambda x: x.Line2).NotNull()

    #     self.validator.RuleFor(lambda x: x.Address).SetValidator(addressValidator)
    #     self.validator.RuleFor(lambda x: x.Forename).NotNull()
    ...
    #         self.validator.RuleFor(lambda x: x.Forename).NotNull()
    #     )
    #     self.validator.RuleFor(lambda x: x.Id).NotEqual(0)
...
#         self.validator.RuleForEach(lambda x: x.NickNames).NotNull()
...
#         testValidatorWithPreValidate.RuleFor(persolambda n: person.Age).GreaterThanOrEqualTo(0)
...
#         testValidatorWithPreValidate.RuleFor(persolambda n: person.Age).MustAsync((age, tokenlambda ): Task.FromResult(age >= 0))
...
#         testValidatorWithPreValidate.RuleFor(lambda x: x.Surname).NotNull()
...
#         self.validator.RuleFor(lambda x: x.Address.Line1).NotNull().WithMessage("{PropertyName}")
...
#         self.validator.RuleFor(lambda x: x.Surname).NotEmpty()
#         self.validator.RuleFor(lambda x: x.Forename).NotEmpty()
