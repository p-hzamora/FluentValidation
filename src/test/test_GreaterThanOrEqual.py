...
class GreaterThanOrEqualToValidatorTester(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.validator = TestValidator(lambda v: v.rule_for(lambda x: x.Id).GreaterThanOrEqualTo(self.value))
    ...
    def test_Validates_with_nullable_property(self):
        validator = TestValidator(lambda v: v.rule_for(lambda x: x.Id).GreaterThanOrEqualTo(lambda x: x.NullableInt))
    ...
    def test_Validates_nullable_with_nullable_property(self):
        validator = TestValidator(lambda v: v.rule_for(lambda x: x.NullableInt).GreaterThanOrEqualTo(lambda x: x.OtherNullableInt))
    ...
    def test_Validates_with_nullable_when_property_is_null(self):
        validator = TestValidator(lambda v: v.rule_for(lambda x: x.NullableInt).GreaterThanOrEqualTo(5))
    ...
    def test_Validates_with_nullable_when_property_is_null_cross_property(self):
        validator = TestValidator(lambda v: v.rule_for(lambda x: x.NullableInt).GreaterThanOrEqualTo(lambda x: x.Id))
